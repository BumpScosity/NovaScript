...
{
  "\"end of file\"", "error", "\"invalid token\"", "STRING", "PRINT",
  "SEMICOLON", "LPAREN", "RPAREN", "UNKNOWN", "$accept", "program",
...
yyreduce:
  ...
  switch (yyn)
    {
  case 5: /* statement: PRINT LPAREN STRING RPAREN SEMICOLON  */
#line 30 "parser.y"
